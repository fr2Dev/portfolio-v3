        ...
        <div>
          <Card variant="browser">
            <p style={{ marginBottom: '10px' }}>
              ...
              <TwitterLink href="#">@OpenClassrooms</TwitterLink> and still look forward to learning
              new things every day. Currently at <TwitterLink href="#">@Filae</TwitterLink>, I work
